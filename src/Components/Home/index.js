...
const Home=()=>
        ...
        <div className="Home" id="Home">
            <div className="Home-details-section">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none" className="Home-details-section-left-size-red-arc">
                ...
                <p className="Home-details-section-sub-heading">Discover the beauty of the tropics</p>
                <div className="Home-details-section-heading-container">
                    <h2>
                ...
                <div className="Home-section-decarative-black-ring">
                ...
                <div className="Home-section-decarative-yellow-ring">
            ...
            <div className="home-page-student-img-container">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                ...
                <img src="https://res.cloudinary.com/dspbnevuo/image/upload/v1693555070/Group_171_o96jsg.png" alt='student' className="home-page-student-img" />
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none" className="Home-section-decarative-green-ring">
